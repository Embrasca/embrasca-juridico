(function (root, factory) {
  ...
  if (root) root.EmbrascaLegalUnified = api;
})(typeof globalThis !== 'undefined' ? globalThis : this, function () {
  const CENTRAL_STATUS_LABELS = {
    draft: 'Gerado',
  ...
  function centralView(doc, legacy) {
    return {
      ...
      statusLabel: CENTRAL_STATUS_LABELS[doc?.status] || String(doc?.status || 'Gerado'),
  ...
  return { mergeDocuments, centralView, legacyView };
});
